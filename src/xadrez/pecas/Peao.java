...
//no primeiro movimento do pe?o, ele pode se mover 2 casas, caso estejam desocupadas
                mat[p.getLinha()][p.getColuna()] = true;
            }
            ...
            if (this.posicao.getLinha() == 3) {// a linha onde o pe?o tem de estar
                ...
                if (getTabuleiro().posicaoExiste(esquerda) && existePecaAdversaria(esquerda)
                    ...
                    // vulneravel a
                    // enPeassant
                    mat[esquerda.getLinha() - 1][esquerda.getColuna()] = true;// o pe?o se move para cima do pe?o q sera
                    // capturado, n?o para a mesma posicao
                }
                ...
                if (getTabuleiro().posicaoExiste(direita) && existePecaAdversaria(direita)
                    ...
                    // vulneravel a
                    // enPeassant
                    mat[direita.getLinha() - 1][direita.getColuna()] = true;// o pe?o se move para cima do pe?o q sera
                    // capturado, n?o para a mesma posicao
                }
            }
...
//no primeiro movimento do pe?o, ele pode se mover 2 casas, caso estejam desocupadas
            ...
            // movimento especial enPeassant
            if (this.posicao.getLinha() == 4) {// a linha onde o pe?o tem de estar
                Posicao esquerda = new Posicao(this.posicao.getLinha(), this.posicao.getColuna() - 1);
