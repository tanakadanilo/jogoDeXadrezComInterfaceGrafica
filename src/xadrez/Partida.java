...
public class Partida {
    ...
    public PecaXadrez trocarPecaPromovida(String tipo) {
        if (promovida == null) {// caso n?o tenha pe?a a ser promovida
            throw new IllegalStateException("N?o existe pe?a para ser promovida");
        }
        ...
        pecasNoTabuleiro.remove(p);// retirando pe?o do jogo, para ser substituido
    ...
    private PecaXadrez novaPeca(String tipo, Cor cor) {
        ...
        // sem if para n?o dar problema de compila??o
    ...
    private void desfazerMover(Posicao inicial, Posicao destino, Peca pecaCapturada) {
        ...
        if (p instanceof Peao) {
            if (inicial.getColuna() != destino.getColuna() && pecaCapturada == vulneravelEnPeassant) {// caso o peao
                ...
                PecaXadrez peao = (PecaXadrez) tabuleiro.removePeca(destino);// a pe?a foi devolvida para a posi??o
                // errada, por essa jogada fugir ao
                // padrao do xadrez, ent?o mover para a
                // posi??o certa
                Posicao posicaoPeaoCapturado;
